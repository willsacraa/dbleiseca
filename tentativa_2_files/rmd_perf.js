...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 2150 }, { marker: 'pandoc', elapsed: 350 }, { marker: 'post-processor', elapsed: 10 }, { marker: 'pre-processor', elapsed: 30 }, { marker: 'render', elapsed: 3500 } ];
